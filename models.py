...
class CTCLayer(keras.layers.Layer):
    ...
    def call(self, y_true, y_pred):
        ...
        return y_pred
def goat_some7x7_filter(img_width, img_height, char, lr_value):
    ...
    x = keras.layers.Conv2D(64, (7, 7), activation="relu", kernel_initializer="he_normal", padding="same", name="Conv1")(input_img)
    x = keras.layers.Conv2D(128, (5, 5), activation="relu", kernel_initializer="he_normal", padding="same", name="Conv2")(x)
    x = keras.layers.MaxPooling2D((2, 2), name="pool1")(x)
    x = keras.layers.Conv2D(64, (7, 7), activation="relu", kernel_initializer="he_normal", padding="same", name="Conv3")(x)
    x = keras.layers.Conv2D(128, (5, 5), activation="relu", kernel_initializer="he_normal", padding="same", name="Conv4")(x)
    ...
    return model   
def goat_only5x5_filter(img_width, img_height, char, lr_value):
    """Builds a handwriting recognition model.
    ...
    x = keras.layers.Conv2D(64, (5, 5), activation="relu", kernel_initializer="he_normal", padding="same", name="Conv1")(input_img)
    x = keras.layers.Conv2D(128, (5, 5), activation="relu", kernel_initializer="he_normal", padding="same", name="Conv2")(x)
    x = keras.layers.MaxPooling2D((2, 2), name="pool1")(x)
    x = keras.layers.Conv2D(64, (5, 5), activation="relu", kernel_initializer="he_normal", padding="same", name="Conv3")(x)
    x = keras.layers.Conv2D(128, (5, 5), activation="relu", kernel_initializer="he_normal", padding="same", name="Conv4")(x)
    x = keras.layers.MaxPooling2D((2, 2), name="pool2")(x)
    x = keras.layers.Dropout(0.5)(x)
...
def goat_5x5_filter(img_width, img_height, char, lr_value):
    """Builds a handwriting recognition model.
    ...
    return model   
# GOAT SCALED UP
def build_goat_scaled_up(img_width, img_height, char, lr_value):
    """Builds a handwriting recognition model.
...
def build_model9v4_scaled_up(img_width, img_height, char, lr_value):
    input_img = keras.Input(shape=(img_width, img_height, 1), name="image")
    labels = keras.layers.Input(name="label", shape=(None,))
